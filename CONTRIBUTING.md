...
When you submit a PR to conpositor there is only one way to guarantee its merging, please make a draft pr for an issue. If you submit a pr for an issue assigned to no one I will likely review and work on merging it, but if its assigned it'll likely need to be resolved case by case. I likely wont be too strict with this early on, if the project gathers significant contributors however I will need to be stricter. Really just don't try to "be cool" by beating someone to an issue.
